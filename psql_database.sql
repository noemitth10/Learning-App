...
--
-- Name: lesson_sentences; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: lesson_sentences_ls_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.lesson_sentences_ls_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.lesson_sentences_ls_id_seq OWNER TO postgres;

--
-- Name: lesson_sentences_ls_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.lesson_sentences_ls_id_seq OWNED BY public.lesson_sentences.ls_id;
...
--
-- Name: lessons_2; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.lessons_2 (
    lesson_id integer NOT NULL,
    category character varying(100),
    text_of_lesson text,
    level integer
...
ALTER TABLE public.lessons_2 OWNER TO postgres;

--
-- Name: lessons_2_lesson_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.lessons_2_lesson_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.lessons_2_lesson_id_seq OWNER TO postgres;

--
-- Name: lessons_2_lesson_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.lessons_2_lesson_id_seq OWNED BY public.lessons_2.lesson_id;
...
--
-- Name: sentence_words; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sentence_words OWNER TO postgres;

--
-- Name: sentence_words_sw_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.sentence_words_sw_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.sentence_words_sw_id_seq OWNER TO postgres;

--
-- Name: sentence_words_sw_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.sentence_words_sw_id_seq OWNED BY public.sentence_words.sw_id;
...
ALTER TABLE public.sentences_sentence_id_seq OWNER TO postgres;
...
--
-- Name: lesson_sentences ls_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson_sentences ALTER COLUMN ls_id SET DEFAULT nextval('public.lesson_sentences_ls_id_seq'::regclass);
...
--
-- Name: lessons_2 lesson_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons_2 ALTER COLUMN lesson_id SET DEFAULT nextval('public.lessons_2_lesson_id_seq'::regclass);
...
--
-- Name: sentence_words sw_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sentence_words ALTER COLUMN sw_id SET DEFAULT nextval('public.sentence_words_sw_id_seq'::regclass);
...
COPY public.labels (label_id, name) FROM stdin;
\.


--
-- Data for Name: lesson_sentences; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lesson_sentences (ls_id, sentence_id, lesson_id) FROM stdin;
\.
...
--
-- Data for Name: lessons_2; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lessons_2 (lesson_id, category, text_of_lesson, level) FROM stdin;
1	Az  llˇtm ny	Az  llˇtm ny a tagolt mondat k”zponti szerepű mondatr‚sze. Az alany az a mondatr‚sz, amely megnevezi azt a dolgot, szem‚lyt, amelyre az  llˇtm ny meg llapˇt sa vonatkozik.\nA mondat  llˇt s t tartalmazza, a Mit  llˇtok? k‚rd‚sre v laszol. Igei term‚szetű mondatr‚sz, de ez nem azt jelenti hogy csak ige lehet, hanem azt, hogy ki kell fejeznie a benne megfogalmazott  llˇt s idej‚t, az alany szem‚ly‚t ‚s sz m t, ‚s a besz‚l‹nek az igem˘dokban kifejezett viszonyul s t az esem‚nyekhez.	1
\.
...
--
-- Data for Name: sentence_words; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.sentence_words (sw_id, sentence_id, word_id) FROM stdin;
\.
...
COPY public.sentences (sentence_id, sentence, type) FROM stdin;
1	Anna ‚s Peti testv‚rek.	egyszerű
2	A l ny fut.	egyszerű
3	Cili szeret levélben üzenni a barátainak.	egyszerű, kijelentő mondat
\.
...
14	2	Noémi Evelin Tóth	noemitth.10@gmail.com	$2b$10$AQovs4DPuIIPFvHonLIigecrhu.HVebfdsd5BkUD0E9bglDCnlZp2	Férfi	2021-03-07	Ózd	\N	\N	10
15	2	áéűúóüúűőöÍ	test@gmail.com	$2b$10$TY9SLCUiUq8QIcXzCx4I.eBo8KI8VQp3VEhoJRaqYeP1mlQtJU.EG	Férfi	2021-03-07	Budapest	\N	\N	\N
13	2	Noémi	auth@gmail.com	$2b$10$hTcGiab7bPIOHY5c/Faq.udX2euBbnTRV/hBsxq.egDKCiArqM952	Nő	1998-10-10	Budapest	\N	\N	10
19	2	New user	newuser@gmail.com	$2b$10$2i/TOObMGB4ww.qEXLN4ZONUHTs8uuv0.CkeX.vw6mttvQBV3u6m2	Nő	1998-04-26	New Town	\N	\N	\N
...
COPY public.words (word_id, word, label_id) FROM stdin;
\.
...
--
-- Name: lesson_sentences_ls_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.lesson_sentences_ls_id_seq', 1, false);


--
-- Name: lessons_2_lesson_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.lessons_2_lesson_id_seq', 1, true);
...
--
-- Name: sentence_words_sw_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.sentence_words_sw_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.sentences_sentence_id_seq', 3, true);
...
--
-- Name: lesson_sentences lesson_sentences_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson_sentences
    ADD CONSTRAINT lesson_sentences_pkey PRIMARY KEY (ls_id);


--
-- Name: lessons_2 lessons_2_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons_2
    ADD CONSTRAINT lessons_2_pkey PRIMARY KEY (lesson_id);
...
--
-- Name: sentence_words sentence_words_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sentence_words
    ADD CONSTRAINT sentence_words_pkey PRIMARY KEY (sw_id);
...
--
-- Name: words fk_labels; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.words
    ADD CONSTRAINT fk_labels FOREIGN KEY (label_id) REFERENCES public.labels(label_id) ON DELETE CASCADE;


--
-- Name: lesson_sentences fk_lessons; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson_sentences
    ADD CONSTRAINT fk_lessons FOREIGN KEY (lesson_id) REFERENCES public.lessons(lesson_id) ON DELETE CASCADE;
...
--
-- Name: lesson_sentences fk_sentences; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson_sentences
    ADD CONSTRAINT fk_sentences FOREIGN KEY (sentence_id) REFERENCES public.sentences(sentence_id) ON DELETE CASCADE;


--
-- Name: sentence_words fk_sentences; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sentence_words fk_words; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sentence_words
    ADD CONSTRAINT fk_words FOREIGN KEY (word_id) REFERENCES public.words(word_id) ON DELETE CASCADE;
